 ...
 * @param ratio_pad An optional parameter that specifies scaling and padding factors as a pair of
 *values. The first value (ratio) is used for scaling, and the second value (pad) is used for
 *padding. If not provided, default values will be used.
 ...
 *
 * This function rescales a bounding box from the shape of the input image (img1_shape) to the shape
 *of an original image (img0_shape).
 */
