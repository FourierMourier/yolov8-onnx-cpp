...
const std::vector<std::vector<int>> skeleton = {{16, 14},
                                                {14, 12},
                                                {17, 15},
                                                {15, 13},
                                                {12, 13},
...
const std::vector<int> limbColorIndices =
    {9, 9, 9, 9, 7, 7, 7, 0, 0, 0, 0, 0, 16, 16, 16, 16, 16, 16, 16};
const std::vector<int> kptColorIndices = {16, 16, 16, 16, 16, 0, 0, 0, 0, 0, 0, 9, 9, 9, 9, 9, 9};
